        ...
        {[
          {
            ...
            description: 'Perfect for saving money with competitive interest rates',
            icon: '🏦',
          },
          {
            type: 'CURRENT',
          ...
          },
          {
            ...
            description: 'Specially designed for salaried individuals',
            icon: '💰',
          },
        ].map((accountType) => (
          <Card
            key={accountType.type}
            className="cursor-pointer hover:shadow-lg transition-all duration-200 text-center p-6"
          >
            <div className="text-4xl mb-3">{accountType.icon}</div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">{accountType.title}</h3>
            <p className="text-sm text-gray-600">{accountType.description}</p>
            <Link href={`/accounts/new?type=${accountType.type}`}>
