 ...
 *
 * A Tier-1 core banking portal has no public marketing landing and no
 ...
 *
 * The root URL therefore behaves as any Tier-1 CBS does on cold entry:
 * if the operator already holds a valid server-side
